...
```bash
curl -s -L -O https://github.com/gradle/develocity-build-validation-scripts/releases/download/v2.9.0/develocity-gradle-build-validation-2.9.0.zip && unzip -q -o develocity-gradle-build-validation-2.9.0.zip
```
