...
```bash
curl -s -L -O https://github.com/gradle/develocity-build-validation-scripts/releases/download/v2.8.1/develocity-maven-build-validation-2.8.1.zip && unzip -q -o develocity-maven-build-validation-2.8.1.zip
```
