...
plugins {
    id("base")
    id("com.felipefzdz.gradle.shellcheck") version "1.5.1"
...
val buildScanSummaryVersion = "1.0.7-2024.1"
...
dependencies {
    ...
    thirdPartyMavenComponents("com.gradle:common-custom-user-data-maven-extension:2.1.0")
}
